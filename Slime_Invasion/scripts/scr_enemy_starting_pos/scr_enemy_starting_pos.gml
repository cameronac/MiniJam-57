...
if (argument3) {
	var sprite_speed = 20; // frames per second
	var frames_in_animation = 20; // frames
	...
	if (excess_beginning_frames > frames_in_animation) {
		idle_frames += frames_in_animation;
		moving_frames += (excess_beginning_frames - frames_in_animation);
	} else {
